<?php
// customerlogin.php (UI) — shows messages when ?just_registered=1 and pre-fills username using ?prefill=
...
<head>
  ...
  <title>Customer Login — Credit Without Barriers</title>
    ...
    <div class="col-md-6">
      <div class="card p-4">
        ...
        <form method="post" action="customer_auth.php" novalidate>
          ...
          <div class="mb-3 position-relative pwd-wrap">
  <div class="mb-3">
